...
namespace EDFile
{
    ...
    public class CryptoBase
    {
        ...
        public String Encrypt(String data, String pass, CryptoBase.EncoderMode em)
        {
            ...
            if (em == EncoderMode.Base64Encoder)
                return Convert.ToBase64String(EncryptEx(Encode.GetBytes(data), Encode.GetBytes(pass)));
            else
                return ByteToHex(EncryptEx(Encode.GetBytes(data), Encode.GetBytes(pass)));
        }
        /// <summary>
        /// 带编码模式的字符串解密
        /// </summary>
        ...
        public String Decrypt(String data, String pass, CryptoBase.EncoderMode em)
        {
            if (data == null || pass == null) return null;
            if (em == EncoderMode.Base64Encoder)
                return Encode.GetString(DecryptEx(Convert.FromBase64String(data), Encode.GetBytes(pass)));
            else
                return Encode.GetString(DecryptEx(HexToByte(data), Encode.GetBytes(pass)));
        }
        /// <summary>
        /// 加密
        /// </summary>
        ...
        /// <returns>密文</returns>
        virtual public Byte[] EncryptEx(Byte[] data, byte[] pass) { return null; }
        /// <summary>
        /// 解密
        /// </summary>
        /// <param name="data">要解密的数据</param>
        /// <param name="pass">密码</param>
        /// <returns>明文</returns>
        virtual public Byte[] DecryptEx(Byte[] data, byte[] pass) { return null; }
    ...
    public class RC4Crypto : CryptoBase
    {
        ...
        public override Byte[] EncryptEx(Byte[] data, byte[] pass)
        {
            if (data == null || pass == null) return null;
        ...
        public override Byte[] DecryptEx(Byte[] data, byte[] pass)
        {
